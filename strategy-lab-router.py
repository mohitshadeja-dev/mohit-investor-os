    ...
    for di in range(1,len(sessions)):
        ...
        while count<maxtr:
            ...
            for typ,r in refs.items():
                ...
                # A >120-point gap-up plus red first 5m candle blocks the
                # Resistance LONG but keeps its Sell Below as the first SHORT.
                # Apply the exact opposite behavior after a large gap-down.
